...
public class CustomerView {
    ...
    public CustomerView(){
        Customer customer = new Customer("王涛",'男',23,"12341234","wt@gmail.com");
...
//break结束循环，跳出，修改客户信息
        ...
        String name = CMUtility.readString(10,cust.getName());//输入姓名以输入为准，直接换行以默认姓名为准
